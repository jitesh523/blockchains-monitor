...
class Config:
    ...
    RISK_THRESHOLDS = {
        ...
        "liquidity": {"low": 0.1, "medium": 0.3, "high": 0.6},
        "governance": {"low": 0.3, "medium": 0.6, "high": 0.9},
    }

    # Model Parameters
    GARCH_PARAMS = {"p": 1, "q": 1, "mean": "Zero", "vol": "GARCH", "dist": "Normal"}

    ARIMA_PARAMS = {"order": (1, 1, 1), "seasonal_order": (1, 1, 1, 12)}
    ...
    def validate_config(cls) -> bool:
        ...
        required_keys = ["ETHERSCAN_API_KEY", "INFURA_PROJECT_ID"]
