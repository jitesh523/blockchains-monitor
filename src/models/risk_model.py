...
from .sentiment_model import get_sentiment_for_protocol
...
class RiskAssessment:
    ...
    def __init__(self):
        self.weights = {"volatility": 0.4, "sentiment": 0.3, "governance": 0.2, "technical": 0.1}
        ...
        try:
            ...
            return {
                ...
                "components": {
                    ...
                    "governance": {"score": governance_score, "weight": self.weights["governance"]},
                    "technical": {"score": technical_score, "weight": self.weights["technical"]},
                },
...
async def get_portfolio_risk(protocol_names: List[str]) -> Dict:
    ...
    return {"individual_risks": risk_results, "portfolio_analysis": risk_assessor.compare_protocols(risk_results)}
...
async def test_risk_assessment():
    ...
    print(
        f"  Lowest Risk: {portfolio_analysis['lowest_risk']['protocol']} ({portfolio_analysis['lowest_risk']['overall_risk_score']})"
    )
    print(
        f"  Highest Risk: {portfolio_analysis['highest_risk']['protocol']} ({portfolio_analysis['highest_risk']['overall_risk_score']})"
    )
