...
class MonitoringService:
    ...
    async def start(self):
        ...
        await asyncio.gather(self.health_check_loop(), self.metrics_collection_loop(), self.alert_check_loop())
        ...
        while self.is_running:
            try:
                ...
                health_checks = await asyncio.gather(
                    self.check_database_health(), self.check_redis_health(), self.check_api_health()
                )
    ...
    async def metrics_collection_loop(self):
        ...
        while self.is_running:
            try:
                ...
                logger.info(
                    f"System metrics - CPU: {metrics.cpu_percent}%, Memory: {metrics.memory_percent}%, Disk: {metrics.disk_percent}%"
                )
    ...
    async def send_alert(self, alert: Dict[str, Any]):
        ...
        try:
            alert_user(
                ...
                channel="slack",
                metadata={"severity": alert["severity"], "timestamp": datetime.now().isoformat()},
            )
    ...
    def get_metrics_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "averages_1h": {"cpu_percent": avg_cpu, "memory_percent": avg_memory, "disk_percent": avg_disk},
